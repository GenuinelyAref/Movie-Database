...
<form method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]."?page=../admin/new_movie");?>">
    ...
    if ($double_director = "no") {
      ?>
      <div>
        <input type="radio" name="double_director" value="no" checked="checked"/> One director
      ...
      <div>
        ...
        <input type="radio" name="double_director" value="yes" checked="checked"/> Two co-directors
      </div>
      <div>
        <b>Co-director 1:</b> &nbsp;
        <!-- dropdown menu -->
